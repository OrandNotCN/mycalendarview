...
import com.lacuz.cherish.utils.ScreenUtils;
...
//        initStatusBar();
    ...
    private void initStatusBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            View view = findViewById(R.id.viewStatusBar);
            view.setVisibility(VISIBLE);
            ViewGroup.LayoutParams params = view.getLayoutParams();
            params.height = ScreenUtils.getStatusBarHeight(getContext());
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        title_textSize = typedArray.getDimensionPixelSize(R.styleable.CustomTitlebar_title_textSize, sp2px(context, 18));
        ...
        /**分割线*/
        setLineIsVisible(typedArray.getBoolean(R.styleable.CustomTitlebar_show_line, true)?VISIBLE:GONE);
